...
const Footer = () => {
    return (
                    ...
                    <div className="max-w-xl mx-auto">
                        ...
                        <form action="#" className="mt-2">
                            <div className="flex items-center">
                                ...
                                <button className="bg-blue-600 text-gray-200 px-5 py-2 rounded shadow " style={{ marginLeft: '-7.8rem' }}>
                                    Sign Up
          </button>
                            </div>
                        </form>
      ...
      <svg fill="#e53e3e" viewBox="0 0 24 24" className="w-5 h-5 mx-1 pt-px text-red-600" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" /></svg>by Mohammed Ibrahim(Jermine Junior).
    </p>
                    <div className="flex items-center">
                        <a href="#">
